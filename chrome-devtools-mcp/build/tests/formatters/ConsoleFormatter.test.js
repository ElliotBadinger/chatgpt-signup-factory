...
describe('ConsoleFormatter', () => {
    describe('toString', () => {
        ...
        it('formats a console.log message with one argument', async (t) => {
            ...
            const result = (await ConsoleFormatter.from(message, { id: 2, fetchDetailedData: true })).toString();
            t.assert.snapshot?.(result);
        });
        it('formats a console.log message with multiple arguments', async (t) => {
            ...
            const result = (await ConsoleFormatter.from(message, { id: 3, fetchDetailedData: true })).toString();
            t.assert.snapshot?.(result);
        });
    });
    describe('toStringDetailed', () => {
        it('formats a console.log message', async (t) => {
            ...
            const result = (await ConsoleFormatter.from(message, { id: 1 })).toStringDetailed();
            t.assert.snapshot?.(result);
        });
        it('formats a console.log message with one argument', async (t) => {
            const message = createMockMessage({
            ...
            const result = (await ConsoleFormatter.from(message, { id: 2, fetchDetailedData: true })).toStringDetailed();
            t.assert.snapshot?.(result);
        });
        it('formats a console.log message with multiple arguments', async (t) => {
            const message = createMockMessage({
            ...
            const result = (await ConsoleFormatter.from(message, { id: 3, fetchDetailedData: true })).toStringDetailed();
            t.assert.snapshot?.(result);
        });
        it('formats a console.error message', async (t) => {
            ...
            const result = (await ConsoleFormatter.from(message, { id: 4 })).toStringDetailed();
            t.assert.snapshot?.(result);
        });
        it('formats a console message with a stack trace', async (t) => {
            ...
            const result = (await ConsoleFormatter.from(message, {
                id: 5,
    ...
    describe('toJSONDetailed', () => {
        it('formats a console.log message', async () => {
            ...
            const result = (await ConsoleFormatter.from(message, { id: 1 })).toJSONDetailed();
            assert.deepStrictEqual(result, {
                id: 1,
                type: 'log',
                text: 'Hello, world!',
        ...
        it('formats a console.log message with args', async () => {
            ...
            const result = (await ConsoleFormatter.from(message, { id: 2, fetchDetailedData: true })).toJSONDetailed();
            assert.deepStrictEqual(result, {
                id: 2,
                type: 'log',
                text: 'Processing file:',
