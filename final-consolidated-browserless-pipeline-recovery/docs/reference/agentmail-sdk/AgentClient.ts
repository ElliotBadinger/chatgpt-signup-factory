// This file was copied from /tmp/agentmail-node/src/api/resources/agent/client/Client.ts
// as a local reference for the confirmed /v0/agent/sign-up and /v0/agent/verify API surface.
