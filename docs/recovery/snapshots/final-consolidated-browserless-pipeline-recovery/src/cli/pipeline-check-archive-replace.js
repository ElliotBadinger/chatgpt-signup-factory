...
import { createConfiguredCodexLbStore } from '../pipeline/rotation/codexLbLocalImportClient.js';
...
const codexLbStore = createConfiguredCodexLbStore();
...
try {
  ...
  maxInboxAttempts: Number.parseInt(process.env.ROTATION_MAX_INBOX_ATTEMPTS ?? '5', 10),
